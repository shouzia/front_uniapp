<template>
	<view class="content">
        <view class="box"
              :style='{"margin":"0 5%","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 1)","height":"auto"}'>
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>账户
			 </view>
			 <input
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>用户编号
			 </view>
			 <input
					:style='{"padding":"0 30rpx","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>用户姓名
			 </view>
			 <input
					:style='{"padding":"0 30rpx","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>用户手机号
			 </view>
			 <input
					:style='{"padding":"0 30rpx","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
		 ...
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>用户身份证号
			 </view>
			 <input
					:style='{"padding":"0 30rpx","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
			...
			<view v-if="tableName=='yonghu'" @tap="yonghuPhotoTap" class="cu-form-group">
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>用户头像
				</view>
				<image
			...
			<view v-if="tableName=='yonghu'" class="cu-form-group select">
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'
					  class="title">性别</view>
				<picker @change="yonghusexTypesChange" :value="sexTypesIndex" :range="sexTypesOptions" range-key="indexName">
					<view :style='{"padding":"0 30rpx","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
						  class="uni-input picker-select-input">{{ruleForm.sexValue?ruleForm.sexValue:"请选择性别"}}</view>
				</picker>
			</view>
		 <view v-if="tableName=='yonghu'" class="cu-form-group">
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"#9cc8ff","textAlign":"left"}'>用户邮箱
			 </view>
			 <input
					:style='{"padding":"0 30rpx","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
		...
		<view class="btn" style="margin-top:40rpx">
			<view class="box" :style="{width: 'auto'}">
				<button @tap="update()" class="cu-btn lg"
					:style='{"margin":"0 30rpx 0 0","boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"#9cc8ff","borderColor":"#9cc8ff","borderRadius":"8rpx","color":"#fff","borderWidth":"0","width":"auto","fontSize":"32rpx","borderStyle":"solid","height":"80rpx"}'>保存</button>
			</view>
		
			<view class="box" :style="{width: 'auto'}">
				<button @tap="logout()" class="cu-btn lg"
					:style='{"boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"red","borderColor":"#E6A23C","borderRadius":"8rpx","color":"#fff","borderWidth":"0px","width":"auto","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}'>退出登录</button>
			</view>
		</view>
	</view>
...
export default {
  ...
  async onLoad() {
    ...
    if (this.tableName == 'yonghu') {
      ...
      let jinyong_typesRes = await this.$api.page(
        `dictionary`,
        jinyong_typesParams
      )
  ...
  methods: {
    ...
    yonghusexTypesChange(e) {
      ...
      this.ruleForm.sexValue =
        this.sexTypesOptions[this.sexTypesIndex].indexName
      this.ruleForm.sexTypes =
        this.sexTypesOptions[this.sexTypesIndex].codeIndex
    },
    // 下拉变化
    yonghujinyongTypesChange(e) {
      this.jinyongTypesIndex = e.target.value
      this.ruleForm.jinyongValue =
        this.jinyongTypesOptions[this.jinyongTypesIndex].indexName
      this.ruleForm.jinyongTypes =
        this.jinyongTypesOptions[this.jinyongTypesIndex].codeIndex
    },
    // 日期控件
