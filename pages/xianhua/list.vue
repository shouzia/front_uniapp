    ...
    <mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
        ...
        <view class="cu-bar bg-white search" :style="[{ top: CustomBar + 'px' }]">
            <view class="search-form round">
                <input
                    :style='{ "padding": "0 30rpx", "margin": "0", "borderColor": "rgba(0,0,0,.6)", "backgroundColor": "#fff", "color": "#333", "textAlign": "left", "borderRadius": "20rpx", "borderWidth": "2px", "fontSize": "28rpx", "borderStyle": "solid", "height": "60rpx" }'
                    v-model="searchForm.xianhuaName" type="text" placeholder="鲜花名称"></input>
            </view>

            <view class="action">
                <view style="background-color: #69cef0;"
                    :style="{ width: '40rpx', borderRadius: '40rpx 0 0 40rpx', height: '80rpx' }">
                </view>
                <view @tap="search" style="background-color: #69cef0;"
                    :style="{ padding: '0 10rpx', lineHeight: '80rpx', width: 'auto', height: '80rpx', fontSize: '28rpx', color: 'rgba(239, 239, 239, 1)' }">
                    搜索
                </view>
                <view @click="showDrawer()" style="background-color: #69cef0;"
                    :style="{ padding: '0 10rpx', lineHeight: '80rpx', width: 'auto', height: '80rpx', fontSize: '28rpx', color: 'rgba(239, 239, 239, 1)' }">
                    类型
                </view>
                <view style="background-color: #69cef0;"
                    :style="{ width: '40rpx', borderRadius: '0 40rpx 40rpx 0', height: '80rpx' }">
                </view>
            </view>
        </view>
                    ...
                    <view style="display: flex;">
                        <view style="display: flex;flex-direction: column;width: 100%;">
                            <view :style='xianhuaTypes === item.codeIndex ? sactiveItem : sitem' class="tab"
                                v-for="(item, index) in xianhuaTypesList" :key="index"
                                :class="xianhuaTypes === item.codeIndex ? 'tabActive' : ''"
