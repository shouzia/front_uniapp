<template>
    <view class="content">
        <view class="box" :style='{ "padding": "48rpx 60rpx 150rpx", }'>
            <view>
                <div style="font-size: 28px; line-height: 54rpx; font-weight: 700;">欢迎注册</div>
            </view>
            <view v-if="tableName == 'yonghu'" class="uni-form-item uni-column" style="margin-top: 60px;">
                <input
            ...
            <view>
                <button @tap="register" type="primary"
                    :style='{ "padding": "0", "margin": "0", "backgroundColor": "#3e98f7", "borderRadius": "40rpx", "color": "rgba(255, 255, 255, 1)", "borderWidth": "2rpx", "width": "100%", "fontSize": "32rpx", "borderStyle": "solid", "height": "88rpx" }'>注册</button>
            </view>
        </view>
    </view>
</template>
