<template>
	<view style="margin: 0 30rpx;">
		...
		<view style="font-weight:700;font-size: 16px; line-height: 32px; margin:0 30rpx 5rpx;"
			:style="(detail.gonggaoValue == null || detail.insertTime == null) ? 'text-align: center;' : ''">
		...
		<div>
			<image style="margin-top: 20px; object-fit: cover; width: 100%; height: 300px;"
				:src="baseUrl + detail.gonggaoPhoto"></image>
		</div>
		<view class="content">
...
export default {
	...
	methods: {
		...
		// 获取详情
		async init() {
			let res = await this.$api.detail('gonggao', this.gonggaoId);
